...
RTPSDUMP_CFLAGS = $(CFLAGS) -std=c++0x -DSQLITE_PREPARE_V2 -DRTI_ENDIAN_LITTLE
RTPSDUMP_CFLAGS_DEBUG = $(CFLAGS_DEBUG) -std=c++0x -DSQLITE_PREPARE_V2 -DRTI_ENDIAN_LITTLE
...
$(RTPSDUMP_TARGET_DEBUG): $(RTPSDUMP_OBJS_DEBUG)
	$(LN) $(LDFLAGS) -o $(RTPSDUMP_TARGET_DEBUG) $(LIBRARY_PATH) $(RTPSDUMP_LIBS_DEBUG) $(RTPSDUMP_OBJS_DEBUG) $(RTPSDUMP_STATIC_LIBS)

$(RTPSDUMP_TARGET): $(RTPSDUMP_OBJS_RELEASE)
	$(LN) $(LDFLAGS) -o $(RTPSDUMP_TARGET) $(LIBRARY_PATH) $(RTPSDUMP_LIBS_RELEASE) $(RTPSDUMP_OBJS_RELEASE) $(RTPSDUMP_STATIC_LIBS)
