...
Estructura_seqPluginSupport_create_data_ex(RTIBool allocate_pointers){
    Estructura_seq *sample = NULL;

    RTIOsapiHeap_allocateStructure(
        &sample, Estructura_seq);

    if(sample != NULL) {
        if (!Estructura_seq_initialize_ex(sample,allocate_pointers, RTI_TRUE)) {
            RTIOsapiHeap_freeStructure(sample);
            return NULL;
        }
    }        
...
{
    return Estructura_seqPluginSupport_create_data_ex(RTI_TRUE);
}
...
Estructura_seqPluginSupport_destroy_data_ex(
    ...
    Estructura_seq_finalize_ex(sample,deallocate_pointers);
...
Estructura_seqPluginSupport_destroy_data(
    ...
    Estructura_seqPluginSupport_destroy_data_ex(sample,RTI_TRUE);
...
{
    return Estructura_seq_copy(dst,src);
}
    ...
    unsigned int indent_level)
{
    ...
    if (sample == NULL) {
        ...
        if (EstructuraSeq_get_contiguous_bufferI(sample) != NULL) {
            RTICdrType_printArray(
                EstructuraSeq_get_contiguous_bufferI(sample), 
                EstructuraSeq_get_length(sample),
                sizeof(Estructura),
                (RTICdrTypePrintFunction)EstructuraPluginSupport_print_data,
                "", indent_level + 1);
        } else {
            RTICdrType_printPointerArray(
                EstructuraSeq_get_discontiguous_bufferI(sample), 
                EstructuraSeq_get_length(sample),
                (RTICdrTypePrintFunction)EstructuraPluginSupport_print_data,
                "", indent_level + 1);
        }
...
{
    if (endpoint_data) {} /* To avoid warnings */
    return Estructura_seqPluginSupport_copy_data(dst,src);
}
    ...
    void *endpoint_plugin_qos)
{
    ...
    if (EstructuraSeq_get_contiguous_bufferI(sample) != NULL) {
        if (!RTICdrStream_serializeNonPrimitiveSequence(
            ...
            (100),
            sizeof(Estructura),
            (RTICdrStreamSerializeFunction)EstructuraPlugin_serialize,
        ...
        if (!RTICdrStream_serializeNonPrimitivePointerSequence(
            stream,
            (const void **)EstructuraSeq_get_discontiguous_bufferI(sample),
            EstructuraSeq_get_length(sample),
            (100),
            (RTICdrStreamSerializeFunction)EstructuraPlugin_serialize,
            RTI_FALSE, encapsulation_id,RTI_TRUE,
    ...
    void *endpoint_plugin_qos)
{
    ...
    if(deserialize_sample) {
        Estructura_seq_initialize_ex(sample, RTI_FALSE, RTI_FALSE);
    
    {
        ...
        if (EstructuraSeq_get_contiguous_bufferI(sample) != NULL) {
            if (!RTICdrStream_deserializeNonPrimitiveSequence(
                ...
                EstructuraSeq_get_contiguous_bufferI(sample),
                &sequence_length,
                EstructuraSeq_get_maximum(sample),
                sizeof(Estructura),
                (RTICdrStreamDeserializeFunction)EstructuraPlugin_deserialize_sample,
                RTI_FALSE,RTI_TRUE,
                endpoint_data,endpoint_plugin_qos)) {
                return RTI_FALSE;
            }
            ...
            if (!RTICdrStream_deserializeNonPrimitivePointerSequence(
                stream,
                (void **)EstructuraSeq_get_discontiguous_bufferI(sample),
                &sequence_length,
                EstructuraSeq_get_maximum(sample),
                (RTICdrStreamDeserializeFunction)EstructuraPlugin_deserialize_sample,
                RTI_FALSE,RTI_TRUE,
...
RTIBool Estructura_seqPlugin_skip(
    PRESTypePluginEndpointData endpoint_data,
    struct RTICdrStream *stream,   
    RTIBool skip_encapsulation,
    RTIBool skip_sample, 
    void *endpoint_plugin_qos)
{
...

    {
        ...
        if (!RTICdrStream_skipNonPrimitiveSequence(
            ...
            &sequence_length,
            sizeof(Estructura),
            (RTICdrStreamSkipFunction)EstructuraPlugin_skip,
            RTI_FALSE,RTI_TRUE,
            endpoint_data,endpoint_plugin_qos)) {
            return RTI_FALSE;
        }
    ...
    unsigned int current_alignment)
{
    ...
    current_alignment +=  RTICdrType_getNonPrimitiveSequenceMaxSizeSerialized(
        ...
        EstructuraPlugin_get_serialized_sample_max_size,RTI_FALSE,encapsulation_id,endpoint_data);
    ...
    unsigned int current_alignment)
{
    ...
    current_alignment +=  RTICdrType_getNonPrimitiveSequenceMaxSizeSerialized(
        current_alignment, 0,
        EstructuraPlugin_get_serialized_sample_min_size,RTI_FALSE,encapsulation_id,endpoint_data);
    ...
    const Estructura_seq * sample) 
{
    ...
    if (EstructuraSeq_get_contiguous_bufferI(sample) != NULL) {
        current_alignment += RTICdrStream_getNonPrimitiveSequenceSerializedSize(
            current_alignment, EstructuraSeq_get_length(sample),
            sizeof(Estructura),
            (RTICdrTypeGetSerializedSampleSizeFunction)EstructuraPlugin_get_serialized_sample_size,
            RTI_FALSE,encapsulation_id,
            EstructuraSeq_get_contiguous_bufferI(sample),
            endpoint_data);
    } else {
    ...
    void *endpoint_plugin_qos)
{
    ...
    if (EstructuraSeq_get_contiguous_bufferI(sample) != NULL) {
        if (!RTICdrStream_serializeNonPrimitiveSequence(
            ...
            (100),
            sizeof(Estructura),
            (RTICdrStreamSerializeFunction)EstructuraPlugin_serialize_key,
            RTI_FALSE, encapsulation_id,RTI_TRUE,
            endpoint_data,endpoint_plugin_qos)) {
            return RTI_FALSE;
        }
...
RTIBool Estructura_seqPlugin_deserialize_key_sample(
    PRESTypePluginEndpointData endpoint_data,
    Estructura_seq *sample, 
    struct RTICdrStream *stream,
    RTIBool deserialize_encapsulation,
...

    {
        ...
        if (EstructuraSeq_get_contiguous_bufferI(sample) != NULL) {
            if (!RTICdrStream_deserializeNonPrimitiveSequence(
                ...
                EstructuraSeq_get_maximum(sample),
                sizeof(Estructura),
                (RTICdrStreamDeserializeFunction)EstructuraPlugin_deserialize_key_sample,
                RTI_FALSE,RTI_TRUE,
                endpoint_data,endpoint_plugin_qos)) {
                return RTI_FALSE;
            }
    ...
    unsigned int current_alignment)
{
    ...
    current_alignment +=  RTICdrType_getNonPrimitiveSequenceMaxSizeSerialized(
        current_alignment, (100),
        EstructuraPlugin_get_serialized_key_max_size,RTI_FALSE,encapsulation_id,endpoint_data);
...

    {
        ...
        if (EstructuraSeq_get_contiguous_bufferI(sample) != NULL) {
            if (!RTICdrStream_deserializeNonPrimitiveSequence(
                ...
                EstructuraSeq_get_maximum(sample),
                sizeof(Estructura),
                (RTICdrStreamDeserializeFunction)EstructuraPlugin_serialized_sample_to_key,
                RTI_FALSE,RTI_TRUE,
                endpoint_data,endpoint_plugin_qos)) {
                return RTI_FALSE;
            }
...
CompletypeInSequence *
CompletypeInSequencePluginSupport_create_data_ex(RTIBool allocate_pointers){
    CompletypeInSequence *sample = NULL;

    RTIOsapiHeap_allocateStructure(
        &sample, CompletypeInSequence);

    if(sample != NULL) {
        if (!CompletypeInSequence_initialize_ex(sample,allocate_pointers, RTI_TRUE)) {
            RTIOsapiHeap_freeStructure(sample);
            return NULL;
        }
    }        
...
{
    return CompletypeInSequencePluginSupport_create_data_ex(RTI_TRUE);
}
...
CompletypeInSequencePluginSupport_destroy_data_ex(
    ...
    CompletypeInSequence_finalize_ex(sample,deallocate_pointers);
...
CompletypeInSequencePluginSupport_destroy_data(
    ...
    CompletypeInSequencePluginSupport_destroy_data_ex(sample,RTI_TRUE);
...
{
    return CompletypeInSequence_copy(dst,src);
}
    ...
    void *containerPluginContext)
{
   ...
   if (containerPluginContext) {} /* To avoid warnings */
    ...
    epd = PRESTypePluginDefaultEndpointData_new(
            ...
            endpoint_info,
            (PRESTypePluginDefaultEndpointDataCreateSampleFunction)
            CompletypeInSequencePluginSupport_create_data,
            (PRESTypePluginDefaultEndpointDataDestroySampleFunction)
            CompletypeInSequencePluginSupport_destroy_data,
            NULL, NULL);
    ...
    if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
        serializedSampleMaxSize = CompletypeInSequencePlugin_get_serialized_sample_max_size(
            epd,RTI_FALSE,RTI_CDR_ENCAPSULATION_ID_CDR_BE,0);
        ...
        if (PRESTypePluginDefaultEndpointData_createWriterPool(
                ...
                endpoint_info,
            (PRESTypePluginGetSerializedSampleMaxSizeFunction)
                CompletypeInSequencePlugin_get_serialized_sample_max_size, epd,
            (PRESTypePluginGetSerializedSampleSizeFunction)
...
{
    if (endpoint_data) {} /* To avoid warnings */
    return CompletypeInSequencePluginSupport_copy_data(dst,src);
}
    ...
    void *endpoint_plugin_qos)
{
    ...
    if (!Estructura_seqPlugin_serialize(
            endpoint_data,
            &sample->seq, 
            stream, 
            RTI_FALSE, encapsulation_id, 
    ...
    void *endpoint_plugin_qos)
{
    ...
    if(deserialize_sample) {
        CompletypeInSequence_initialize_ex(sample, RTI_FALSE, RTI_FALSE);
    
    if (!Estructura_seqPlugin_deserialize_sample(
            endpoint_data,
            &sample->seq,
            stream, 
            RTI_FALSE, RTI_TRUE, 
    ...
    void *endpoint_plugin_qos)
{
    ...
    return CompletypeInSequencePlugin_deserialize_sample( 
        endpoint_data, (sample != NULL)?*sample:NULL,
        stream, deserialize_encapsulation, deserialize_sample, 
        endpoint_plugin_qos);
...
RTIBool CompletypeInSequencePlugin_skip(
    PRESTypePluginEndpointData endpoint_data,
    struct RTICdrStream *stream,   
    RTIBool skip_encapsulation,
    RTIBool skip_sample, 
    ...
    unsigned int current_alignment)
{
    ...
    current_alignment +=  Estructura_seqPlugin_get_serialized_sample_max_size(
        endpoint_data,RTI_FALSE,encapsulation_id,current_alignment);
    ...
    unsigned int current_alignment)
{
    ...
    current_alignment +=  Estructura_seqPlugin_get_serialized_sample_min_size(
        endpoint_data,RTI_FALSE,encapsulation_id,current_alignment);
    ...
    const CompletypeInSequence * sample) 
{
    ...
    current_alignment += Estructura_seqPlugin_get_serialized_sample_size(
        endpoint_data,RTI_FALSE, encapsulation_id, 
        current_alignment, &sample->seq);
    ...
    void *endpoint_plugin_qos)
{
    ...
    if(serialize_key) {
        ...
        if (!CompletypeInSequencePlugin_serialize(
                endpoint_data,
                sample,
                stream,
                RTI_FALSE, encapsulation_id,
...
RTIBool CompletypeInSequencePlugin_deserialize_key_sample(
    PRESTypePluginEndpointData endpoint_data,
    CompletypeInSequence *sample, 
    struct RTICdrStream *stream,
    RTIBool deserialize_encapsulation,
    ...
    void *endpoint_plugin_qos)
{
    ...
    if (deserialize_key) {
        ...
        if (!CompletypeInSequencePlugin_deserialize_sample(
                endpoint_data, sample, stream,
                RTI_FALSE, RTI_TRUE, 
                endpoint_plugin_qos)) {
            return RTI_FALSE;
...
RTIBool CompletypeInSequencePlugin_deserialize_key(
    PRESTypePluginEndpointData endpoint_data,
    CompletypeInSequence **sample, 
    RTIBool * drop_sample,
    struct RTICdrStream *stream,
...
{
    if (drop_sample) {} /* To avoid warnings */
    return CompletypeInSequencePlugin_deserialize_key_sample(
        endpoint_data, (sample != NULL)?*sample:NULL, stream,
        deserialize_encapsulation, deserialize_key, endpoint_plugin_qos);
}
    ...
    unsigned int current_alignment)
{
    ...
    current_alignment += CompletypeInSequencePlugin_get_serialized_sample_max_size(
        endpoint_data,RTI_FALSE, encapsulation_id, current_alignment);
...
struct PRESTypePlugin *CompletypeInSequencePlugin_new(void) 
{ 
    struct PRESTypePlugin *plugin = NULL;
    const struct PRESTypePluginVersion PLUGIN_VERSION = 
        PRES_TYPE_PLUGIN_VERSION_2_0;
    ...
    plugin->createSampleFnc =
        (PRESTypePluginCreateSampleFunction)
        CompletypeInSequencePlugin_create_sample;
    plugin->destroySampleFnc =
        (PRESTypePluginDestroySampleFunction)
        CompletypeInSequencePlugin_destroy_sample;
    ...
    plugin->getSampleFnc =
        (PRESTypePluginGetSampleFunction)
        CompletypeInSequencePlugin_get_sample;
    plugin->returnSampleFnc =
        (PRESTypePluginReturnSampleFunction)
        CompletypeInSequencePlugin_return_sample;

    plugin->getKeyKindFnc =
        (PRESTypePluginGetKeyKindFunction)
        CompletypeInSequencePlugin_get_key_kind;
    ...
    */
    ...
    plugin->typeCode =  (struct RTICdrTypeCode *)CompletypeInSequence_get_typecode();
    ...
    plugin->getBuffer = 
        (PRESTypePluginGetBufferFunction)
        CompletypeInSequencePlugin_get_buffer;
    plugin->returnBuffer = 
        (PRESTypePluginReturnBufferFunction)
        CompletypeInSequencePlugin_return_buffer;
    plugin->getSerializedSampleSizeFnc =
        (PRESTypePluginGetSerializedSampleSizeFunction)
        CompletypeInSequencePlugin_get_serialized_sample_size;

    plugin->endpointTypeName = CompletypeInSequenceTYPENAME;

    return plugin;
}

void
CompletypeInSequencePlugin_delete(struct PRESTypePlugin *plugin)
{
    RTIOsapiHeap_freeStructure(plugin);
} 
