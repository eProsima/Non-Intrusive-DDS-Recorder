...
void gen_find_size(const HelloWorld& stru, size_t& size, size_t& padding)
{
  ...
  size += ACE_OS::strlen(stru.message) + 1;
}
...
HelloWorldTypeSupportImpl::HelloWorldTypeSupportImpl ()
{
}
...
::DDS::ReturnCode_t
HelloWorldTypeSupportImpl::register_type (
...
char *
HelloWorldTypeSupportImpl::get_type_name ()
{
...
::DDS::DataWriter_ptr
HelloWorldTypeSupportImpl::create_datawriter ()
{
  HelloWorldDataWriterImpl* writer_impl;
  ACE_NEW_RETURN(writer_impl,
                 HelloWorldDataWriterImpl(),
                 ::DDS::DataWriter::_nil());
...
::DDS::DataReader_ptr
HelloWorldTypeSupportImpl::create_datareader ()
{
  HelloWorldDataReaderImpl* reader_impl = 0;
  ACE_NEW_RETURN(reader_impl,
                 HelloWorldDataReaderImpl(),
                 ::DDS::DataReader::_nil());
...
::DDS::DataReader_ptr
HelloWorldTypeSupportImpl::create_multitopic_datareader()
{
  return new OpenDDS::DCPS::MultiTopicDataReader_T<HelloWorld,
    HelloWorldDataReaderImpl>;
}
#endif
...
HelloWorldTypeSupportImpl::getMetaStructForType()
{
  return OpenDDS::DCPS::getMetaStruct<HelloWorld>();
}

#endif

bool
HelloWorldTypeSupportImpl::has_dcps_key()
{
  return OpenDDS::DCPS::gen_has_key(HelloWorld());
}


HelloWorldDataWriterImpl::HelloWorldDataWriterImpl ()
  : marshaled_size_ (0)
...
HelloWorldDataWriterImpl::register_instance (
...
::DDS::InstanceHandle_t
HelloWorldDataWriterImpl::register_instance_w_timestamp (
    const ::HelloWorld & instance,
    const ::DDS::Time_t & timestamp)
{
  ...
  if (ret != ::DDS::RETCODE_OK)
  {
    ACE_ERROR ((LM_ERROR,
                ACE_TEXT("(%P|%t) ")
                ACE_TEXT("HelloWorldDataWriterImpl::")
...
::DDS::ReturnCode_t
HelloWorldDataWriterImpl::unregister_instance (
    const ::HelloWorld & instance,
...
::DDS::ReturnCode_t
HelloWorldDataWriterImpl::unregister_instance_w_timestamp (
    const ::HelloWorld & instance,
    ::DDS::InstanceHandle_t handle,
    const ::DDS::Time_t & timestamp)
{
  ...
  // HelloWorldDataWriter can remove the instance here.
  return OpenDDS::DCPS::DataWriterImpl::unregister_instance_i(handle, timestamp);
}

::DDS::ReturnCode_t
HelloWorldDataWriterImpl::write (
...
::DDS::ReturnCode_t
HelloWorldDataWriterImpl::write_w_timestamp (
    const ::HelloWorld & instance_data,
    ::DDS::InstanceHandle_t handle,
    const ::DDS::Time_t & source_timestamp)
{
  ...
  if (handle == ::DDS::HANDLE_NIL)
  {
    ...
    if (ret != ::DDS::RETCODE_OK)
    {
      ACE_ERROR_RETURN ((LM_ERROR,
                         ACE_TEXT("(%P|%t) ")
                         ACE_TEXT("HelloWorldDataWriterImpl::write, ")
...
::DDS::ReturnCode_t
HelloWorldDataWriterImpl::dispose (
    const ::HelloWorld & instance_data,
...
::DDS::ReturnCode_t
HelloWorldDataWriterImpl::dispose_w_timestamp (
    const ::HelloWorld & instance_data,
    ::DDS::InstanceHandle_t instance_handle,
    const ::DDS::Time_t & source_timestamp)
{
  if(instance_handle == ::DDS::HANDLE_NIL)
  {
    ...
    if (instance_handle == ::DDS::HANDLE_NIL)
    {
      ACE_ERROR_RETURN ((LM_ERROR,
                         ACE_TEXT("(%P|%t) ")
                         ACE_TEXT("HelloWorldDataWriterImpl::dispose, ")
...
::DDS::ReturnCode_t
HelloWorldDataWriterImpl::get_key_value (
...
::DDS::InstanceHandle_t
HelloWorldDataWriterImpl::lookup_instance (
    const ::HelloWorld & instance_data)
{
  ACE_GUARD_RETURN (ACE_Recursive_Thread_Mutex,
                    guard,
    ...
    )
{
  ...
  OpenDDS::DCPS::KeyOnly<const ::HelloWorld > ko(data);
...
::DDS::ReturnCode_t
HelloWorldDataWriterImpl::enable_specific ()
{
  ::HelloWorld data;
  if (OpenDDS::DCPS::gen_is_bounded_size (data))
  {
    ...
    if (::OpenDDS::DCPS::DCPS_debug_level >= 2)
      ACE_DEBUG((LM_DEBUG,
                 ACE_TEXT("(%P|%t) HelloWorldDataWriterImpl::")
  ...
  else
  {
    if (::OpenDDS::DCPS::DCPS_debug_level >= 2)
      ACE_DEBUG((LM_DEBUG,
                 ACE_TEXT("(%P|%t) HelloWorldDataWriterImpl::enable_specific")
...
// Note: The HelloWorldDataWriter gives ownership of the marshalled data
//       to the WriteDataContainer.
ACE_Message_Block*
HelloWorldDataWriterImpl::dds_marshal(
  const ::HelloWorld& instance_data,
  OpenDDS::DCPS::MarshalingType marshaling_type)
{
  ...
  if (marshaling_type == OpenDDS::DCPS::KEY_ONLY_MARSHALING) {
    ...
    OpenDDS::DCPS::KeyOnly<const ::HelloWorld > ko_instance_data(instance_data);
...
::DDS::ReturnCode_t
HelloWorldDataWriterImpl::get_or_create_instance_handle(
  ::DDS::InstanceHandle_t& handle,
  const ::HelloWorld& instance_data,
  const ::DDS::Time_t & source_timestamp)
{
    ...
    if (needs_creation)
    {
      ...
      if (pair.second == false)
      {
        ...
        ACE_ERROR_RETURN ((LM_ERROR,
                           ...
                           ACE_TEXT("insert HelloWorld failed. \n")),
                          ::DDS::RETCODE_ERROR);
      }
...
void
HelloWorldDataWriterImpl::unregistered(
  ::DDS::InstanceHandle_t /* instance_handle */)
{
...
HelloWorldDataReaderImpl::HelloWorldDataReaderImpl ()
  : data_allocator_ (0)
{
}

::DDS::ReturnCode_t
HelloWorldDataReaderImpl::enable_specific ()
{
  data_allocator_ = new DataAllocator(get_n_chunks ());
  if (::OpenDDS::DCPS::DCPS_debug_level >= 2)
    ACE_DEBUG((LM_DEBUG,
               ACE_TEXT("(%P|%t) HelloWorldDataReaderImpl::")
               ACE_TEXT("enable_specific-data")
               ACE_TEXT(" Cached_Allocator_With_Overflow ")
               ACE_TEXT("%x with %d chunks\n"),
               data_allocator_,
...
::DDS::ReturnCode_t
HelloWorldDataReaderImpl::delete_contained_entities ()
{
...
::DDS::ReturnCode_t
HelloWorldDataReaderImpl::read_i (
    ::HelloWorldSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::CORBA::Long max_samples,
    ::DDS::SampleStateMask sample_states,
...
#endif
{
  ::HelloWorldSeq::PrivateMemberAccess received_data_p(received_data);
  ...
  ::OpenDDS::DCPS::RakeResults< ::HelloWorldSeq >
...
::DDS::ReturnCode_t
HelloWorldDataReaderImpl::take_i (
    ::HelloWorldSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::CORBA::Long max_samples,
    ::DDS::SampleStateMask sample_states,
...
::DDS::ReturnCode_t
HelloWorldDataReaderImpl::read_w_condition (
    ::HelloWorldSeq & received_data,
...
::DDS::ReturnCode_t
HelloWorldDataReaderImpl::take_w_condition (
    ::HelloWorldSeq & received_data,
    ::DDS::SampleInfoSeq & sample_info,
    ::CORBA::Long max_samples,
    ::DDS::ReadCondition_ptr a_condition)
...
::DDS::ReturnCode_t
HelloWorldDataReaderImpl::read_next_sample (
        ...
        (ptr->instance_state_.instance_state() & ::DDS::ANY_INSTANCE_STATE))
    {
           ...
           item = item->next_data_sample_)
      {
        ...
        if (item->sample_state_ & ::DDS::NOT_READ_SAMPLE_STATE)
        {
          ...
          {
            received_data =
              *static_cast< ::HelloWorld *> (item->registered_data_);
          }
...
::DDS::ReturnCode_t
HelloWorldDataReaderImpl::take_next_sample (
    ::HelloWorld & received_data,
    ::DDS::SampleInfo & sample_info)
{
  bool found_data = false;
...
::DDS::ReturnCode_t
HelloWorldDataReaderImpl::read_instance (
    ::HelloWorldSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::CORBA::Long max_samples,
...
::DDS::ReturnCode_t
HelloWorldDataReaderImpl::read_instance_i (
    ::HelloWorldSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::CORBA::Long max_samples,
    ::DDS::InstanceHandle_t a_handle,
...
::DDS::ReturnCode_t
HelloWorldDataReaderImpl::take_instance (
    ::HelloWorldSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::CORBA::Long max_samples,
    ::DDS::InstanceHandle_t a_handle,
...
::DDS::ReturnCode_t
HelloWorldDataReaderImpl::take_instance_i (
    ::HelloWorldSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::CORBA::Long max_samples,
    ::DDS::InstanceHandle_t a_handle,
...
::DDS::ReturnCode_t
HelloWorldDataReaderImpl::read_next_instance (
    ::HelloWorldSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::CORBA::Long max_samples,
    ::DDS::InstanceHandle_t a_handle,
...
::DDS::ReturnCode_t
HelloWorldDataReaderImpl::read_next_instance_i (
    ::HelloWorldSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::CORBA::Long max_samples,
    ::DDS::InstanceHandle_t a_handle,
...
::DDS::ReturnCode_t
HelloWorldDataReaderImpl::take_next_instance (
    ::HelloWorldSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::CORBA::Long max_samples,
    ::DDS::InstanceHandle_t a_handle,
...
::DDS::ReturnCode_t
HelloWorldDataReaderImpl::take_next_instance_i (
    ::HelloWorldSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::CORBA::Long max_samples,
    ::DDS::InstanceHandle_t a_handle,
...
::DDS::ReturnCode_t
HelloWorldDataReaderImpl::read_next_instance_w_condition (
    ::HelloWorldSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::CORBA::Long max_samples,
    ::DDS::InstanceHandle_t a_handle,
...
::DDS::ReturnCode_t
HelloWorldDataReaderImpl::take_next_instance_w_condition (
    ::HelloWorldSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::CORBA::Long max_samples,
    ::DDS::InstanceHandle_t a_handle,
...
void
HelloWorldDataReaderImpl::release_loan (
    ::HelloWorldSeq & received_data
  )
{
...
void
HelloWorldDataReaderImpl::dec_ref_data_element(
...
::DDS::ReturnCode_t
HelloWorldDataReaderImpl::return_loan (
    ::HelloWorldSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq)
{
...
::DDS::ReturnCode_t
HelloWorldDataReaderImpl::get_key_value (
    ::HelloWorld & key_holder,
    ::DDS::InstanceHandle_t handle)
{
  ACE_GUARD_RETURN (ACE_Recursive_Thread_Mutex,
...
::DDS::InstanceHandle_t
HelloWorldDataReaderImpl::lookup_instance (
    const ::HelloWorld & instance_data)
{
  InstanceMap::const_iterator const it = instance_map_.find(instance_data);
...
#ifndef OPENDDS_NO_CONTENT_SUBSCRIPTION_PROFILE
bool
HelloWorldDataReaderImpl::contains_sample_filtered(::DDS::SampleStateMask sample_states,
    ...
    if ((inst.instance_state_.view_state() & view_states) &&
      ...
      for (ReceivedDataElement* item = inst.rcvd_samples_.head_; item != 0;
        ...
        if (item->sample_state_ & sample_states
          ...
          if (evaluator.eval(*static_cast< ::HelloWorld* >(item->registered_data_), params)) {
            return true;
          }
        }
      }
...
::DDS::ReturnCode_t
HelloWorldDataReaderImpl::read_generic(
...
::DDS::InstanceHandle_t
HelloWorldDataReaderImpl::lookup_instance_generic(const void* data)
{
  return lookup_instance(*static_cast<const HelloWorld*>(data));
}

::DDS::ReturnCode_t
HelloWorldDataReaderImpl::read_instance_generic(void*& data,
  ...
  ::DDS::InstanceStateMask instance_states)
{
  ...
  data = new HelloWorld(dataseq[last]);
  info = infoseq[last];
  return rc;
}

::DDS::ReturnCode_t
HelloWorldDataReaderImpl::read_next_instance_generic(void*& data,
...
::DDS::InstanceHandle_t
HelloWorldDataReaderImpl::store_synthetic_data(const HelloWorld& sample,
  ::DDS::ViewStateKind view)
{
  ...
  for (int i = 0; i < 2; ++i) {
    ...
    ACE_NEW_MALLOC_NORETURN(data,
      static_cast< HelloWorld*>(data_allocator_->malloc(sizeof(HelloWorld))),
      HelloWorld(sample));
...
void
HelloWorldDataReaderImpl::set_instance_state(::DDS::InstanceHandle_t instance,
...
void
HelloWorldDataReaderImpl::dds_demarshal(
  ...
  OpenDDS::DCPS::MarshalingType marshaling_type)
{
  ...
  ACE_NEW_MALLOC_NORETURN(data,
                          static_cast< ::HelloWorld *>(
                            data_allocator_->malloc(sizeof(::HelloWorld))),
                           ::HelloWorld);
  ...
  if (marshaling_type == OpenDDS::DCPS::KEY_ONLY_MARSHALING) {
    ser >> ::OpenDDS::DCPS::KeyOnly< ::HelloWorld>(*data);
  } else {
    ser >> *data;
  }
...
void
HelloWorldDataReaderImpl::lookup_instance(const OpenDDS::DCPS::ReceivedDataSample& sample,
                                        OpenDDS::DCPS::SubscriptionInstance*& instance)
{
...
void
HelloWorldDataReaderImpl::store_instance_data(
  ...
  if (it == instance_map_.end())
  {
    ...
    if (this->is_exclusive_ownership_) {
      if (this->owner_manager_->instance_lock_acquire () != 0) {
        ACE_ERROR ((LM_ERROR,
                    ACE_TEXT("(%P|%t) ")
                    ACE_TEXT("HelloWorldDataReaderImpl::")
      ...
      if (new_handle) {
        ...
        if (bpair.second == false)
        {
          ACE_ERROR ((LM_ERROR,
                      ...
                      ACE_TEXT("HelloWorldDataReaderImpl::")
                      ACE_TEXT("store_instance_data, ")
                      ACE_TEXT("insert to participant scope ::HelloWorld failed. \n")));
          return;
        }
      }
...
void
HelloWorldDataReaderImpl::dispose(const OpenDDS::DCPS::ReceivedDataSample& sample,
                                OpenDDS::DCPS::SubscriptionInstance*& instance)
{
  //!!! caller should already have the sample_lock_
...
void
HelloWorldDataReaderImpl::unregister(const OpenDDS::DCPS::ReceivedDataSample& sample,
                                   OpenDDS::DCPS::SubscriptionInstance*& instance)
{
  //!!! caller should already have the sample_lock_
...
::DDS::ReturnCode_t
HelloWorldDataReaderImpl::auto_return_loan(void* seq)
{
  ::HelloWorldSeq& received_data =
    *static_cast< ::HelloWorldSeq*> (seq);
...
::DDS::ReturnCode_t
HelloWorldDataReaderImpl::check_inputs (
  ...
  )
{
  ...
  {
    ACE_DEBUG((LM_DEBUG,
               ACE_TEXT("(%P|%t) HelloWorldDataReaderImpl::%C ")
...
void
HelloWorldDataReaderImpl::purge_data(
    OpenDDS::DCPS::SubscriptionInstance* instance)
{
...
void
HelloWorldDataReaderImpl::release_instance_i (::DDS::InstanceHandle_t handle)
{
  InstanceMap::iterator const the_end = instance_map_.end ();
...
void
HelloWorldDataReaderImpl::delete_instance_map (void* map)
{
...
template<>
struct MetaStructImpl<HelloWorld> : MetaStruct {
  typedef HelloWorld T;
  ...
  {
    const HelloWorld& typed = *static_cast<const HelloWorld*>(stru);
    ...
    throw std::runtime_error("Field " + std::string(field) + " not found or its type is not supported (in Struct HelloWorld)");
  }
  ...
  {
    static const char* names[] = {"counter", "message", 0};
    return names;
  }
  ...
  bool compare(const void* lhs, const void* rhs, const char* field) const
  {
    ...
    if (std::strcmp(field, "message") == 0) {
      return 0 == ACE_OS::strcmp(static_cast<const T*>(lhs)->message, static_cast<const T*>(rhs)->message);
    }
    throw std::runtime_error("Field " + std::string(field) + " not found or its type is not supported (in Struct HelloWorld)");
  }
};
...
{
  static MetaStructImpl<HelloWorld> msi;
  return msi;
}
