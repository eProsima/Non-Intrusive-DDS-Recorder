/* Unions_subscriber.cxx
   ...
   Example subscription of type Unions automatically generated by 
...
class UnionsListener : public DDSDataReaderListener {
  public:
...
void UnionsListener::on_data_available(DDSDataReader* reader)
{
    UnionsDataReader *Unions_reader = NULL;
    UnionsSeq data_seq;
    DDS_SampleInfoSeq info_seq;
    DDS_ReturnCode_t retcode;
    int i;

    Unions_reader = UnionsDataReader::narrow(reader);
    if (Unions_reader == NULL) {
        printf("DataReader narrow error\n");
        return;
    }

    retcode = Unions_reader->take(
    ...
    for (i = 0; i < data_seq.length(); ++i) {
        if (info_seq[i].valid_data) {
            UnionsTypeSupport::print_data(&data_seq[i]);
        }
    }

    retcode = Unions_reader->return_loan(data_seq, info_seq);
...
extern "C" int subscriber_main(int domainId, int sample_count)
{
    ...
    DDSTopic *topic = NULL;
    UnionsListener *reader_listener = NULL; 
    ...
    reader_listener = new UnionsListener();
    ...
    for (count=0; (sample_count == 0) || (count < sample_count); ++count) {
        ...
        printf("Unions subscriber sleeping for %d sec...\n",
               receive_period.sec);
