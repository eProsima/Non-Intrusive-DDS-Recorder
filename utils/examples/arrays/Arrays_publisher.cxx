/* Arrays_publisher.cxx

   A publication of data of type Arrays

   This file is derived from code automatically generated by the rtiddsgen 
   command:

   rtiddsgen -language C++ -example <arch> Arrays.idl

   Example publication of type Arrays automatically generated by 
   ...
   (2) Start the subscription on the same domain used for RTI Data Distribution
       with the command
       objs/<arch>/Arrays_subscriber <domain_id> <sample_count>
                
   (3) Start the publication on the same domain used for RTI Data Distribution
       with the command
       objs/<arch>/Arrays_publisher <domain_id> <sample_count>
   ...
   Example:
       ...
       objs/<arch>/Arrays_publisher <domain_id> o
       objs/<arch>/Arrays_subscriber <domain_id> 
                            
       On Windows:
       
       objs\<arch>\Arrays_publisher <domain_id>  
       objs\<arch>\Arrays_subscriber <domain_id>    
...
extern "C" int publisher_main(int domainId, int sample_count)
{
    ...
    ArraysDataWriter * Arrays_writer = NULL;
    Arrays *instance = NULL;
    DDS_ReturnCode_t retcode;
    ...
    type_name = ArraysTypeSupport::get_type_name();
    retcode = ArraysTypeSupport::register_type(
    ...
    Arrays_writer = ArraysDataWriter::narrow(writer);
    if (Arrays_writer == NULL) {
    ...
    instance = ArraysTypeSupport::create_data();
    if (instance == NULL) {
        printf("ArraysTypeSupport::create_data error\n");
        publisher_shutdown(participant);
        return -1;
    }
...
/*
    instance_handle = Arrays_writer->register_instance(*instance);
*/

    /* Main loop */
    for (count=0; (sample_count == 0) || (count < sample_count); ++count) {

        printf("Writing Arrays, count %d\n", count);
...
/*
    retcode = Arrays_writer->unregister_instance(
...
*/
    ...
    /* Delete data sample */
    retcode = ArraysTypeSupport::delete_data(instance);
    if (retcode != DDS_RETCODE_OK) {
        printf("ArraysTypeSupport::delete_data error %d\n", retcode);
    }
