/* BasicTypes_publisher.cxx

   A publication of data of type BasicTypes
   ...
   Example publication of type BasicTypes automatically generated by 
   ...
   Example:
       ...
       objs/<arch>/BasicTypes_publisher <domain_id> o
...
extern "C" int publisher_main(int domainId, int sample_count)
{
    ...
    BasicTypesDataWriter * BasicTypes_writer = NULL;
    BasicTypes *instance = NULL;
    DDS_ReturnCode_t retcode;
    ...
    BasicTypes_writer = BasicTypesDataWriter::narrow(writer);
    if (BasicTypes_writer == NULL) {
    ...
    instance = BasicTypesTypeSupport::create_data();
    if (instance == NULL) {
        printf("BasicTypesTypeSupport::create_data error\n");
        publisher_shutdown(participant);
        return -1;
    }
...
/*
    retcode = BasicTypes_writer->unregister_instance(
...
*/
    ...
    /* Delete data sample */
    retcode = BasicTypesTypeSupport::delete_data(instance);
    if (retcode != DDS_RETCODE_OK) {
        printf("BasicTypesTypeSupport::delete_data error %d\n", retcode);
    }
